    ...
    <>
      ...
      <AnimatePresence>
        {details && detailsOpen && (
          ...
          exit={{opacity: 0}}
          className={`absolute z-50 text-sm font-[200]  p-2 border rounded-xl bg-darkest-blue flex flex-col gap-2 ${orientation == "left" && "top-0 right-[100%]"} ${orientation == "right" && "top-0 left-[100%] "} ${orientation == "top" && "bottom-[100%]  left-[50%] -translate-x-[50%] "} ${orientation == "bottom" && "top-[100%]  left-[50%] -translate-x-[50%] "}`}>
